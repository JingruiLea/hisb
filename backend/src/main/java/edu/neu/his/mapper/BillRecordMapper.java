...
public interface BillRecordMapper {
    @Insert("INSERT INTO bill_record(medical_record_id, expense_classification_id, type , print_status, " +
            "cost, should_pay, truely_pay, retail_fee, user_id, creat_time) " +
        "VALUES(#{medical_record_id}, #{expense_classification_id}, #{type}, #{print_status}, " +
            "#{cost}, #{should_pay}, #{truely_pay}, #{retail_fee}, #{user_id}, #{creat_time})")
